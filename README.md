gustave [![pipeline status](https://git.stable.innovation.insee.eu/methodologie-sondage/gustave/badges/dev/pipeline.svg)](https://git.stable.innovation.insee.eu/methodologie-sondage/gustave/commits/dev)
=======
